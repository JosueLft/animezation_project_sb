package com.reign.animezation.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	@ExceptionHandler(ResourceNotFoundException.class) // INTERCEPTANDO EXCEÇÕES DO TIPO DEFINIDO
	...
	@ExceptionHandler(DatabaseException.class) // INTERCEPTANDO EXCEÇÕES DO TIPO DEFINIDO
